    ...
    <div className="admin-dashboard">
      <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <ul className="sidebar-menu">
          ...
          <li className="active"><Link to="/admin/reports">Báo cáo</Link></li>
      ...
      <div className={`main-content ${isSidebarOpen ? 'sidebar-open' : ''}`}>
        <header className="dashboard-header">
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <div>
              <h1>Báo cáo</h1>
              <p>Trang báo cáo</p>
              <p>Xem báo cáo tài chính và hiệu suất</p>
            </div>
          </div>
        ...
        <div style={{ padding: '20px', background: '#fff', borderRadius: '24px' }}>
          ...
          <p>Trang này hiện là placeholder. Bạn có thể thiết kế biểu đồ và báo cáo dữ liệu tại đây.</p>
        </div>
      </div>
    </div>
  );
