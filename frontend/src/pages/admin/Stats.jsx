    ...
    <div className="admin-dashboard">
      <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <ul className="sidebar-menu">
          ...
          <li className="active"><Link to="/admin/stats">Thống kê</Link></li>
      ...
      <div className={`main-content ${isSidebarOpen ? 'sidebar-open' : ''}`}>
        <header className="dashboard-header">
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <div>
              <h1>Thống kê</h1>
              <p>Trang thống kê hệ thống</p>
              <p>Xem báo cáo số liệu theo bảng điều khiển</p>
            </div>
          </div>
        ...
        <div style={{ padding: '20px', background: '#fff', borderRadius: '24px' }}>
          ...
          <p>Trang này hiện là placeholder. Bạn có thể triển khai các bảng báo cáo và biểu đồ ở đây.</p>
        </div>
      </div>
    </div>
  );
